...
public final class Constants {
	...
	public static final String GET_TOP_SPEND_DEPT = "/getTopSpendByDept/";
	public static final String SPEND_SERVICE = "/spend";
	
	public static final String PATH_PARAM_CUSTOMER_ID = "customerId";
	public static final String SPEND_TYPE = "spendType";
	public static final String QUERY_PARAM_START_DT = "startDate";
	public static final String QUERY_PARAM_END_DT = "endDate";
