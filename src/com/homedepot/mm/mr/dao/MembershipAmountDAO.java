 ...
 *
 */
public final class MembershipAmountDAO {
	 ...
	 */
	public static MembershipAmountDTO getQuarterlyMembershipSummary(final int custId, final int programId, int mbrshpAmtTypCd, final String year) 
			throws QueryException {
