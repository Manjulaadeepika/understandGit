 ...
 *
 */
public final class MembershipTransactionsDAO {
	 ...
	 * 
	 */
	private MembershipTransactionsDAO() {
		super();
	}
	 ...
	 */
	public static List<ReadCustomerTransactionsDTO> getMembershipTransactions(final int customerId, final int programId, final Date startDate, final Date endDate) 
			throws QueryException {
