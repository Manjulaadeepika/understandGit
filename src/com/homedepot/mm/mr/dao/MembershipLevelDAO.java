...
public final class MembershipLevelDAO {
	 ...
	 */
	public static MembershipLevelDTO getMembershipLevel(final int customerId, final int programId, final Date date) 
			throws QueryException {
